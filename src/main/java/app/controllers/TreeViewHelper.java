...
public class TreeViewHelper
{
    ...
    // This method creates an ArrayList of TreeItem<String>s (Products)
    ...
    // This method creates an ArrayList of TreeItem<String>s (Cars)
    ...
    // This method creates an ArrayList of TreeItem<String>s (Buses)
    ...
    // This method creates an ArrayList of TreeItem<String>s (Trucks)
    ...
    // This method creates an ArrayList of TreeItem<String>s (Motorbikes)
